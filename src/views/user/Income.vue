  ...
  <AdminLayout>
    <div class="flex flex-col gap-6 font-poppins text-left mb-10 pb-20">
      <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between px-2 gap-6">
         <h1 class="text-2xl font-black text-[#333]">Entradas</h1>
            ...
            <table class="w-full text-left">
              <thead>
                <tr class="bg-gray-50/50">
                  <th class="px-8 py-5 text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] w-20">Meio</th>
                  <th class="px-8 py-5 text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] min-w-[200px]">Transação ID</th>
                  <th class="px-8 py-5 text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] min-w-[120px]">Valor Bruto</th>
                  <th class="px-8 py-5 text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] min-w-[120px]">Valor Líquido</th>
              ...
              <tbody class="divide-y divide-gray-100 font-bold">
                <tr v-for="tx in filteredTransactions" :key="tx.id" class="hover:bg-gray-50/50 transition-all cursor-pointer group">
                  <td class="px-8 py-5 text-[#005858]">
                  ...
                  <td class="px-8 py-5">
                    <span class="text-[14px] text-[#005858]">R$ {{ tx.netValue }}</span>
                  </td>
                  <td class="px-8 py-5">
                ...
                <tr v-if="filteredTransactions.length === 0">
                   <td colspan="6" class="px-8 py-10 text-center text-gray-400 font-bold">Nenhuma transação encontrada.</td>
                </tr>
              </tbody>
            </table>
          </div>
