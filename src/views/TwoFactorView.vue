      ...
      <div class="bg-white rounded-[20px] sm:rounded-[24px] shadow-sm border border-gray-200 p-6 sm:p-10 transition-all hover:shadow-md">
        ...
        <form @submit.prevent="handleVerify" class="space-y-6">
          ...
          <div class="space-y-3 mb-8">
            <label class="block text-sm font-bold text-[#333] text-center">Código de Verificação</label>
            <div class="flex justify-center gap-2 sm:gap-3">
              <input 
                ...
                type="text" 
                maxlength="1"
                class="w-11 h-12 sm:w-12 sm:h-14 text-center font-poppins text-xl sm:text-2xl font-bold bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#005858] focus:bg-white focus:ring-2 focus:ring-[#005858]/10 transition-all shadow-sm"
        ...
        <div class="mt-6 sm:mt-8 text-center pt-5 sm:pt-6 border-t border-dashed border-gray-200">
          <p class="text-[13px] sm:text-sm text-gray-500 font-medium mb-4">
            ...
            <button class="text-[#005858] font-bold hover:underline cursor-pointer">Reenviar</button>
          </p>
          <router-link to="/login" class="inline-flex items-center gap-2 text-gray-400 font-bold text-[13px] hover:text-gray-600 hover:gap-3 transition-all">
            <ArrowLeft :size="16" />
            Voltar para o login
          </router-link>
        </div>
